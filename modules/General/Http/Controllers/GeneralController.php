...
class GeneralController extends Controller
{
    ...
    public function pending()
    {
        ...
        if ($role == 3 || $role == 4){
            $Process_items = Process_Item::where('status_id','>=',2)->where('activity_organization',$organization)->orderby('id','desc')->paginate(10);
            return view('general::generalA', [
                'Process_items' => $Process_items,
                'tree_removals' =>$tree_removals,
                'dev_projects'=>$dev_projects
        ...
        //IF STAFF DISPLAYS ALL THE REQUESTS ASSIGNED TO THEM
            ...
            $Process_items = Process_Item::where('activity_user_id', $id)->orderby('id','desc')->paginate(10);
            return view('general::generalA', [
                'Process_items' => $Process_items,
                'tree_removals' =>$tree_removals,
                'dev_projects'=>$dev_projects
