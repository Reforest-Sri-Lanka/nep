...
<nav class="navbar navbar-expand-lg navbar-light justify-content-around">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link h5" href="/reporting/overview">Overview<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link h5" href="/reporting/tree-removal">Tree Removal</a>
            </li>
            <li class="nav-item">
                <a class="nav-link h5" href="/reporting/dev-proj">Development Project</a>
            </li>
            <li class="nav-item">

                <a class="nav-link h5" href="/reporting/restoration">Restoration</a>

            </li>
            <li class="nav-item">
                <a class="nav-link h5" href="/reporting/complaints">Complaints</a>
            </li>
